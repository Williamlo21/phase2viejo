...
-- Volcando estructura de base de datos para bd_phase2
CREATE DATABASE IF NOT EXISTS `bd_phase2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bd_phase2`;

-- Volcando estructura para tabla bd_phase2.departamentos
CREATE TABLE IF NOT EXISTS `departamentos` (
  `id_departamento` bigint unsigned NOT NULL DEFAULT '0',
  `departamento` varchar(255) NOT NULL DEFAULT '',
  PRIMARY KEY (`id_departamento`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.departamentos: ~33 rows (aproximadamente)
INSERT IGNORE INTO `departamentos` (`id_departamento`, `departamento`) VALUES
	(5, 'ANTIOQUIA'),
	(8, 'ATLÁNTICO'),
	(11, 'BOGOTÁ, D.C.'),
	(13, 'BOLÍVAR'),
...
-- Volcando estructura para tabla bd_phase2.equipos_computadores
CREATE TABLE IF NOT EXISTS `equipos_computadores` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_usuario` bigint unsigned NOT NULL DEFAULT '0',
  `referencia` varchar(50) NOT NULL,
  `id_marca_equipo` bigint unsigned NOT NULL,
  `estado` bit(1) NOT NULL DEFAULT b'1',
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `equipoUnico` (`id_usuario`,`referencia`,`id_marca_equipo`),
  KEY `FK_equipos_computadores_marcas_compudatores` (`id_marca_equipo`),
  KEY `FK_equipos_computadores_usuarios` (`id_usuario`),
  CONSTRAINT `FK_equipos_computadores_marcas_compudatores` FOREIGN KEY (`id_marca_equipo`) REFERENCES `marcas_compudatores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_equipos_computadores_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.equipos_computadores: ~0 rows (aproximadamente)

-- Volcando estructura para tabla bd_phase2.evento_entrada_salida
CREATE TABLE IF NOT EXISTS `evento_entrada_salida` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `id_tipo_evento` bigint unsigned NOT NULL,
  `id_usuario` bigint unsigned NOT NULL,
  `id_equipo_computador` bigint unsigned DEFAULT NULL,
  `id_vehiculo` bigint unsigned DEFAULT NULL,
  `id_sede` bigint unsigned DEFAULT NULL,
  `fecha` date NOT NULL,
  `hora` time NOT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_evento_entrada_salida_tipo_evento` (`id_tipo_evento`),
  KEY `FK_evento_entrada_salida_usuarios` (`id_usuario`),
  KEY `FK_evento_entrada_salida_equipos_computadores` (`id_equipo_computador`),
  KEY `FK_evento_entrada_salida_vehiculos` (`id_vehiculo`),
  KEY `FK_evento_entrada_salida_sedes` (`id_sede`),
  CONSTRAINT `FK_evento_entrada_salida_equipos_computadores` FOREIGN KEY (`id_equipo_computador`) REFERENCES `equipos_computadores` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_evento_entrada_salida_sedes` FOREIGN KEY (`id_sede`) REFERENCES `sedes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_evento_entrada_salida_tipo_evento` FOREIGN KEY (`id_tipo_evento`) REFERENCES `tipo_evento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_evento_entrada_salida_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_evento_entrada_salida_vehiculos` FOREIGN KEY (`id_vehiculo`) REFERENCES `vehiculos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.evento_entrada_salida: ~0 rows (aproximadamente)

-- Volcando estructura para tabla bd_phase2.generos
...
-- Volcando datos para la tabla bd_phase2.generos: ~3 rows (aproximadamente)
INSERT IGNORE INTO `generos` (`id`, `nombre`, `estado`, `create_at`) VALUES
	(0, 'SIN IDENTIFICAR', b'1', '2023-02-08 22:14:37'),
	(1, 'MASCULINO', b'1', '2023-02-08 22:14:05'),
	(2, 'FEMENINO', b'1', '2023-02-08 22:14:11');

-- Volcando estructura para tabla bd_phase2.marcas_compudatores
CREATE TABLE IF NOT EXISTS `marcas_compudatores` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) NOT NULL,
  `estado` bit(1) NOT NULL DEFAULT b'1',
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `computador_unico` (`nombre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.marcas_compudatores: ~0 rows (aproximadamente)

-- Volcando estructura para tabla bd_phase2.marcas_vehiculos
CREATE TABLE IF NOT EXISTS `marcas_vehiculos` (
  ...
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `marca_unica_vehiculo` (`nombre`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.marcas_vehiculos: ~0 rows (aproximadamente)

-- Volcando estructura para tabla bd_phase2.municipios
CREATE TABLE IF NOT EXISTS `municipios` (
  `id_municipio` bigint unsigned NOT NULL DEFAULT '0',
...
-- Volcando datos para la tabla bd_phase2.municipios: ~1.100 rows (aproximadamente)
INSERT IGNORE INTO `municipios` (`id_municipio`, `municipio`, `estado`, `id_departamento`) VALUES
	(1, 'Abriaquí', 1, 5),
	(2, 'Acacías', 1, 50),
	(3, 'Acandí', 1, 27),
	(4, 'Acevedo', 1, 41),
...
-- Volcando estructura para tabla bd_phase2.roles
CREATE TABLE IF NOT EXISTS `roles` (
  ...
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `roll_unico` (`nombre`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.roles: ~7 rows (aproximadamente)
INSERT IGNORE INTO `roles` (`id`, `nombre`, `estado`, `create_at`) VALUES
	(0, 'NO IDENTIFICADO', b'1', '2023-02-08 22:26:30'),
	(1, 'APRENDIZ', b'1', '2023-02-07 19:19:41'),
	(2, 'ADMINISTRADOR', b'1', '2023-02-08 22:06:17'),
	(3, 'INSTRUCTOR', b'1', '2023-02-08 22:06:25'),
	(4, 'VIGILANTE', b'1', '2023-02-08 22:10:26'),
	(5, 'ADMINISTRATIVO', b'1', '2023-02-08 22:10:32'),
	(6, 'VISITANTE', b'1', '2023-02-08 22:10:38'),
	(8, 'SUPER ADMIN', b'1', '2024-01-04 17:52:22');

-- Volcando estructura para tabla bd_phase2.sedes
CREATE TABLE IF NOT EXISTS `sedes` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_sedes_municipios` (`id_municipio`),
  CONSTRAINT `FK_sedes_municipios` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.sedes: ~0 rows (aproximadamente)
INSERT IGNORE INTO `sedes` (`id`, `nombre`, `direccion`, `telefono`, `correo_electronico`, `id_municipio`) VALUES
	(1, 'SENA MODELO', 'CRA 19C NO 16 42', '123456', 'SENA@SENA.COM', 824);

-- Volcando estructura para tabla bd_phase2.tipo_documento
...
-- Volcando datos para la tabla bd_phase2.tipo_documento: ~6 rows (aproximadamente)
INSERT IGNORE INTO `tipo_documento` (`id`, `nombre`, `descripcion`, `estado`, `create_at`) VALUES
	(0, 'S.I', 'SIN IDENTIFICACION', b'1', '2023-02-08 22:07:44'),
	(1, 'C.C', 'CEDULA DE CIUDADANIA', b'1', '2023-02-07 19:18:31'),
	(2, 'T.I', 'TARJETA DE IDENTIDAD', b'1', '2023-02-07 19:19:12'),
	(3, 'R.C', 'REGISTRO CIVIL', b'1', '2023-02-07 19:19:29'),
	(4, 'C.E', 'CEDULA DE EXTRANJERIA', b'1', '2023-02-08 22:07:34'),
	(6, 'P.P', 'PASAPORTE', b'1', '2023-02-08 22:07:53');

-- Volcando estructura para tabla bd_phase2.tipo_evento
...
-- Volcando datos para la tabla bd_phase2.tipo_evento: ~3 rows (aproximadamente)
INSERT IGNORE INTO `tipo_evento` (`id`, `nombre`, `estado`, `create_at`) VALUES
	(0, 'NO ESTABLECIDO', b'1', '2023-02-08 22:28:34'),
	(2, 'ENTRADA', b'1', '2023-02-08 22:28:44'),
	(3, 'SALIDA', b'1', '2023-02-08 22:29:28');

-- Volcando estructura para tabla bd_phase2.tipo_vehiculo
CREATE TABLE IF NOT EXISTS `tipo_vehiculo` (
  ...
  `create_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tipo_vehiculo_unico` (`nombre`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.tipo_vehiculo: ~3 rows (aproximadamente)
INSERT IGNORE INTO `tipo_vehiculo` (`id`, `nombre`, `estado`, `create_at`) VALUES
	(0, 'NO ESTABLECIDO', b'1', '2023-02-08 22:30:38'),
	(1, 'AUTOMOVIL', b'1', '2023-02-08 22:29:57'),
	(2, 'MOTOCICLETA', b'1', '2023-02-08 22:30:24');

-- Volcando estructura para tabla bd_phase2.usuarios
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `edad` int unsigned NOT NULL DEFAULT '0',
  `id_generos` bigint unsigned NOT NULL DEFAULT '0',
  ...
  KEY `FK_usuarios_rolles` (`id_roll`),
  KEY `FK_usuarios_generos` (`id_generos`),
  CONSTRAINT `FK_usuarios_generos` FOREIGN KEY (`id_generos`) REFERENCES `generos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_usuarios_rolles` FOREIGN KEY (`id_roll`) REFERENCES `roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_usuarios_tipo_documento` FOREIGN KEY (`id_tipo_documento`) REFERENCES `tipo_documento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT IGNORE INTO `usuarios` (`id`, `id_tipo_documento`, `num_documento`, `primer_nombre`, `segundo_nombre`, `primer_apellido`, `segundo_apellido`, `fecha_nacimiento`, `edad`, `id_generos`, `id_roll`, `direccion`, `telefono`, `correo_electronico`, `usuario`, `password`) VALUES
	...
	(6, 1, '1007293511', 'JOSE', 'WILLIAM', 'LOPEZ', 'REBELLON', NULL, 0, 1, 2, 'MODELO', '3204621201', 'LOPEZREBELLONW@GMAIL.COM', 'Williamlo21', 'Rebeguitar123');

-- Volcando estructura para tabla bd_phase2.vehiculos
CREATE TABLE IF NOT EXISTS `vehiculos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `VEHICULO_UNICO` (`id_usuario`,`id_tipo_vehiculo`,`id_marca`,`placa`) USING BTREE,
  KEY `FK_vehiculos_tipo_vehiculo` (`id_tipo_vehiculo`),
  KEY `FK_vehiculos_marcas_vehiculos` (`id_marca`),
  KEY `FK_vehiculos_usuarios` (`id_usuario`),
  CONSTRAINT `FK_vehiculos_marcas_vehiculos` FOREIGN KEY (`id_marca`) REFERENCES `marcas_vehiculos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_vehiculos_tipo_vehiculo` FOREIGN KEY (`id_tipo_vehiculo`) REFERENCES `tipo_vehiculo` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_vehiculos_usuarios` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla bd_phase2.vehiculos: ~0 rows (aproximadamente)
